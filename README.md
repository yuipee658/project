...
- Обучить модели регрессии (LinearRegression и CatBoostRegressor).
...
- Удалены `region_of_moscow` (исходный) и `link`.
...
**Примечание:** Данная документация составлена на основе анализа кода в `flats_prediction.ipynb`. Реальные результаты и метрики могут отличаться в зависимости от выполнения кода.
